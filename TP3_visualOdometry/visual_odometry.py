...
class VisualOdometry:
    ...
    def compute_relative_transform(self, matches: List[cv2.DMatch], update_src_frame: bool) -> \
        ...
        print(np.shape(src_pts_normalized))
        ...
        if rots:
            ...
            if self.plane_d_src < 0:
                ...
                self.plane_d_src = normals[0].T @ self.c0_M_p[:,3]
            ...
            # TODO create the transfromation matrix from src camera frame to
            ...
            if update_src_frame:
                ...
                d_over_z = src_pts_normalized @ self.plane_normal_src 
                # TODO: result should be an array of <float: num_inliers>
                depth = self.plane_d_src /  d_over_z
                # TODO: compute depth of inlier using d and normalize coordinate, result should be
                # TODO: (continue) an array of <float: num_inliers,>

                # find 3D coordinate in src frame of these inliers
                src_pts_3d =  src_pts_normalized * depth
                # TODO: compute 3d coordinate in src camera frame for every inlier,
                ...
                self.plane_d_src = np.mean(incmoing_pts_3d @ self.plane_normal_src)# TODO
